...
-(void)beginResendCardCodeFunction
{
    ...
    [self startCountdownTime:60 NormalTitle:@"重新发送" normalBgColor:[UIColor clearColor] countdownSubTitle:@"s" countdownTitleColor:COLOR_HEX(0X808080) countdownBgColor:[UIColor clearColor] countdownBorderColor:COLOR_HEX(0X808080) restoreTitleColor:COLOR_HEX(0X01A8EE)];
}

-(void)beginMsgResendCardCodeFunction
{
    [self startCountdownTime:60 NormalTitle:@"获取验证码" normalBgColor:[UIColor clearColor] countdownSubTitle:@"s" countdownTitleColor:COLOR_HEX(0X808080)  countdownBgColor:[UIColor clearColor] countdownBorderColor:[UIColor clearColor] restoreTitleColor:COLOR_HEX(0XF9BA1C)];
}
