...
- (void)setSearchSuggestions:(NSArray<NSString *> *)searchSuggestions
{
    ...
    if (!UIEdgeInsetsEqualToEdgeInsets(self.originalContentInset, UIEdgeInsetsZero) && !UIEdgeInsetsEqualToEdgeInsets(self.originalContentInset, UIEdgeInsetsMake(-30, 0, 30 - kNavagationBarH, 0))) {
