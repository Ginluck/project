...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if (NO == self.navigationController.navigationBar.translucent) {
        ...
        self.searchSuggestionVC.view.frame = CGRectMake(0, kNavagationBarH - self.view.py_y, self.view.py_width, self.view.py_height + self.view.py_y);
...
#pragma clang diagnostic pop
        ...
        searchSuggestionVC.view.frame = CGRectMake(0, kNavagationBarH, PYScreenW, PYScreenH);
...
- (void)setup
{
    ...
    titleView.py_y = 7;
    titleView.py_width = self.view.py_width - kNavagationBarH - titleView.py_x * 2;
    ...
    switch (self.searchResultShowMode) {
        ...
        case PYSearchResultShowModeEmbed:
            if (self.searchResultController) {
                ...
                self.searchResultController.view.hidden = NO;
                self.searchResultController.view.py_y = NO == self.navigationController.navigationBar.translucent ? 0 : kNavagationBarH;
