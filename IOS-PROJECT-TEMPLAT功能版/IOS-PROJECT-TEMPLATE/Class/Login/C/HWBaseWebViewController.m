...
- (void)addMainView {
    HWWeakSelf(weakSelf)
    UIView *mainView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, HWScreenW, HWScreenH-kNavagationBarH)];
...
- (void)creatWebView {
    HWWeakSelf(weakSelf)
    _webView = [[WKWebView alloc] initWithFrame:CGRectMake(0, 0, HWScreenW, HWScreenH-kNavagationBarH)];
