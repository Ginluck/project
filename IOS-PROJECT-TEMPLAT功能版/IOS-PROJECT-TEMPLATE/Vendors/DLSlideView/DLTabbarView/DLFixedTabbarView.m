...
- (void)layoutTabbar {
    ...
    trackView_.frame = CGRectMake(trackX+width/4, self.bounds.size.height-kTrackViewHeight-1, width/2, kTrackViewHeight);
}
...
- (void)switchingFrom:(NSInteger)fromIndex to:(NSInteger)toIndex percent:(float)percent{
    ...
    trackView_.frame = CGRectMake(trackX+width/4, trackView_.frame.origin.y, CGRectGetWidth(trackView_.bounds), CGRectGetHeight(trackView_.bounds));
}
